...
const featured = [
  ...
  { id: "drapery", name: "Custom Drapery", bestFor: "Warmth & Texture", copy: "Layered softness, texture, and craftsmanship tailored to every interior.", image: "/images/about-fabric-detail.png", href: "/solutions/custom-drapery" },
];
