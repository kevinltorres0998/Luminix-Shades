    ...
    <main className={styles.page}>
      ...
      <section className={styles.useCases}>
        ...
        <div className={styles.useGrid}>
          ...
          <motion.a href="mailto:hello@luminixshades.com?subject=Commercial%20Smart%20Film" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: .18 }} transition={{ delay: .08 }}><div className={styles.useCopy}><h2>Commercial</h2><p>Offices, conference rooms, hospitality, healthcare, and retail spaces.</p><b>EXPLORE COMMERCIAL <i>→</i></b></div><div className={styles.useImage}><Image src="/images/commercial-smart-film-cover-v2.png" alt="Premium commercial conference room with Smart Film privacy glass" fill sizes="(max-width: 900px) 100vw, 33vw" /></div></motion.a>
        </div>
      </section>
