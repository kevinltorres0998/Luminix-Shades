...
export default function SiteFooter() {
  return (
    <footer>
      ...
      <div id="faq"><b>RESOURCES</b><Link href="/private-list">The Private List</Link><a href="/#faq">FAQ</a><Link href="/plan-your-project">Get a Quote</Link><a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">Schedule a Consultation</a><Link href="/privacy-policy">Privacy Policy</Link></div>
