...
export default function SiteFooter() {
  return (
    <footer>
      ...
      <div><b>COMPANY</b><a href="/residential">Residential</a><a href="/solutions#finder">Commercial</a><a href="/#projects">Gallery</a><a href="/about">About Us</a><a href="/#contact">Contact</a></div>
