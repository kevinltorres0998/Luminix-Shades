  ...
  return (
    <main>
      ...
      <section className="markets">
        <article><Image src="/images/residential.png" alt="Luxury residential project" fill sizes="50vw" /><div><h2>RESIDENTIAL</h2><p>Homes, condos, penthouses<br />and luxury living spaces.</p><ArrowLink>EXPLORE RESIDENTIAL</ArrowLink></div></article>
        <article><Image src="/images/commercial.png" alt="Luxury commercial project" fill sizes="50vw" /><div><h2>COMMERCIAL</h2><p>Hotels, restaurants, offices<br />and large-scale projects.</p><ArrowLink>EXPLORE COMMERCIAL</ArrowLink></div></article>
      </section>
