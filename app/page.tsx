    ...
    <main className={styles.home}>
      ...
      <section className={styles.hero} id="top">
        ...
        <motion.div className={styles.heroContent} initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .95, ease: [0.22, 1, 0.36, 1] }}>
          ...
          <div className={styles.buttonRow}><a className="button button-gold" href={BOOKING_URL} target="_blank" rel="noopener noreferrer">SCHEDULE A CONSULTATION</a><a className="button button-outline" href="/solutions">EXPLORE OUR SOLUTIONS</a></div>
        </motion.div>
